...
# torch.serialization.add_safe_globals([ModelCheckpoint, scalar, dtype, PosixPath])
...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument(
        ...
        type=str,
        const=True,
        default="/home/seclab/hdd3/REFace/checkpoints/last.ckpt",
    ...
    parser.add_argument(
        ...
        default=["configs/train.yaml"], #"configs/debug.yaml"
    )
    parser.add_argument(
        "-t",
        "--train",
    ...
    parser.add_argument(
        ...
        "--logdir",
        type=str,
        default="/home/seclab/hdd3/REFace",
        help="directory for logging dat shit",
    )
    parser.add_argument(
        "--pretrained_model",
        type=str,
        default="/home/seclab/hdd3/REFace/pretrained_models/sd-v1-4-modified-9channel.ckpt",
...
if __name__ == "__main__":
    ...
    os.environ["PL_TORCH_WEIGHTS_ONLY"] = "0"
    ...
    if opt.debug:
        wandb.init(project="my_reface", name=nowname, config=opt, dir=logdir,resume=resume)
    else:
        wandb.init(project="my_reface", name=nowname, config=opt, dir=logdir,resume=resume)
    print(config)
    ...
    ckpt_path = "/home/seclab/hdd3/REFace/checkpoints/last.ckpt"
